...
echo -e ">>_+====================== SSH Menu =====================+_<<"
echo -e "[1][addssh]       : Agregar usuarios SSH"
echo -e "[2][delssh]       : Eliminar usuarios SSH"
echo -e "[3][expssh]       : Eliminar usuarios SSH caducados"
echo -e "[4][cek]          : Ver inicio de sesión de usuario SSH"
echo -e "[5][listssh]      : Ver la lista de usuarios SSH"
echo -e ">>_+===================== V2Ray Menu ====================+_<<"
echo -e "[6][addv2ray]     : Añadiendo User V2Ray"
echo -e "[7][delv2ray]     : Borrar User V2Ray"
echo -e "[8][expv2ray]     : Borrar User V2Ray yang Expired"
echo -e "[9][listv2ray]    : Ver lista User V2Ray"
echo -e ">>_+====================== SSR Menu =====================+_<<"
